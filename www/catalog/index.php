  ...
  <div class="container">
	...
	array(
		...
		"COMPARE_PROPERTY_CODE" => array(
			...
			23 => "SHAPE_BATH",
			24 => "LENGTH_BATH",
			25 => "TYPE_SHOWER_SYSTEM",
			26 => "HAVING_CEILING_SHOWER",
			27 => "AVAILABILITY_THERMOSTAT",
			28 => "TYPE_FURNITURE",
			29 => "PURPOSE_MIXER",
			30 => "RETRACTABLE_SHOWER",
			31 => "HYGIENIC_SHOWER",
			32 => "BOTTOM_VALVE",
			33 => "CONTROL_TYPE_MIXER",
			34 => "INSTALLATION_TYPE_MIXER",
			35 => "TYPE_INSTALLATION_KITCHEN",
			36 => "MATERIAL_KITCHEN_SINK",
			37 => "FORM_KITCHEN_SINK",
			38 => "NUMBER_BOWLS_KITCHEN_SINK",
			39 => "WIDTH_SINK",
			40 => "WIDTH_FURNITURE",
			41 => "DEPTH_CLEANING",
			42 => "INSTALLATION_TYPE_TOILET",
			43 => "RELEASE_TYPE_TOILET",
			44 => "APPOINTMENT_ACCESSORY",
			45 => "TYPE_SCOPE",
			46 => "AVAILABILITY_MIXER",
			47 => "",
		),
